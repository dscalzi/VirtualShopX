...
public class SQLiteDB implements Database
{
    ...
    private void checkTables()
	{
		...
		if(!db.checkTable("vshop_toggles")){
			String query = "create table vshop_toggles('id' integer primary key,'merchant' varchar(80) not null,'buyconfirm' bit not null,'sellconfirm' bit not null, 'uuid' varchar(80) not null)";
			db.createTable(query);
