...
public class SQLiteDB implements Database
{
    ...
    {
        db = new SQLite(ChatManager.getLogger(), ChatManager.getPrefix(), "VirtualShop", "plugins/VirtualShop/");
		db.open();
		if(!db.checkConnection())
		{
			ChatManager.logInfo("FlatFile creation failed!");
			throw new Exception("FlatFile creation failed.");
		}
		ChatManager.logInfo("Using flat files.");
		checkTables();
